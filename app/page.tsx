...
export default function Home() {
  return (
    <>
      ...
      <section className="py-20 bg-secondary max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 wrap-break-word">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          ...
          <div className="space-y-6 text-justify text-zinc-700">
            <p className="leading-8">
              ...
              <strong>
                Juripiranga celebra 150 anos de fé, cultura e tradição na Festa
                de São Sebastião 2026
              </strong>
            ...
            <p className="leading-8">
              INSPER AGRO GLOBAL.{" "}
              <strong>
                A agricultura familiar produz 70% dos alimentos consumidos pelos
                brasileiros?
              </strong>{" "}
            ...
            <p className="leading-8">
              ...
              https://www.juripiranga.pb.gov.br/a-cidade/historia. Acesso em: 7
              jun. 2026.
            </p>
            ...
            <p className="leading-8">
              ...
              2026. Disponível em:
              https://www.caravela.info/regional/juripiranga---pb. Acesso em: 7
              jun. 2026.
            </p>
            ...
            <p className="leading-8">
              ...
              Iranilson de Oliveira; SOUZA, Antonio Clarindo Barbosa de (org.).
